...
const InstitutionAlerts = () =>{
    ...
    useEffect(() => {
        ...
        async function getAllAlerts(){
            const res= await alerts.findByInstitution(institution.id);
            setAllAlerts(res);
        }
                ...
                <DialogContent sx={{ display: 'flex', flexDirection: 'column', gap: '10px', width:"500px",p:"0 0 10px 0px", m:"15px"}}>
                    <Box ml="20px" mr="20px">
                        <Typography variant="h5" component="div" sx={{mb:"5px"}}>
                            ...
                            <Typography variant="subtitle1" color="text.secondary" component="div" sx={{mb:"20px"}}>
...
export default InstitutionAlerts;